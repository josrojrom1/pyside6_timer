...
class Pomodoro(QWidget):
    def __init__(self): # Inicializamos método constructor de la clase Pomodoro
        super().__init__() # Inicializamos método constructor del padre, QWidget
...
if __name__ == "__main__":
    ...
    #######################
    ### WINDOW SETTINGS ###
    pomodoro.setWindowTitle("Pomodoro with PySide6")
    ...
    click_sound.setSource(QUrl.fromLocalFile("resources/sounds/click.wav"))
    click_sound.setVolume(0.4)
    tic_tac_sound = QSoundEffect()
    tic_tac_sound.setSource(QUrl.fromLocalFile("resources/sounds/tic-tac.wav"))
    tic_tac_sound.setVolume(0.8)
    pomodoro_end_sound = QSoundEffect()
    pomodoro_end_sound.setSource(QUrl.fromLocalFile("resources/sounds/end_timer.wav"))
